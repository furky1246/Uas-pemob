...
$db   = getDB();
$stmt = $db->prepare(
    'SELECT total_score, best_streak, highest_unlocked_surah, current_surah, current_verse
...
if (!$row) {
    // Belum ada progress — kembalikan nilai default
    jsonResponse([
        'total_score'             => 0,
        'best_streak'             => 0,
...
jsonResponse([
    ...
    'current_verse'          => (int) $row['current_verse'],
]);
